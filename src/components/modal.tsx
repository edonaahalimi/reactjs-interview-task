...
export default function Modal({ isOpen, onClose, onSubmit }: any) {
  ...
  return (
    <div>
      <div
        className="fixed top-0 h-screen flex flex-col border border-gray bg-gray-50 m-2 rounded-md w-full p-5 text-black"
        style={modalStyle}
      >
        <div className="flex flex-col h-screen max-w-sm mt-[30px]">
          ...
          <div className="flex items-center flex-grow w-[570px] justify-between">
            ...
            <div className="text-white">
              <button
                className="border border-green-500 bg-green-500"
